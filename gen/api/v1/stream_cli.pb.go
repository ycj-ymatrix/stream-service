...
func NewStreamDemoServiceCommand(use string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   use,
		Short: "",
	...
	cmd.AddCommand(newStreamDemoServicePingPongCommand())
	return cmd
}

func newStreamDemoServicePingPongCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "ping-pong",
		Short: "",
	}
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		client := NewStreamDemoServiceClient(conn)
